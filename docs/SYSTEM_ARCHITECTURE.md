...
> 📁 **Thư mục tài nguyên sơ đồ:** [docs/diagrams](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams)

---

## 1. Kiến trúc Hệ thống Tổng quan (High-Level System Architecture)
🔗 *Xem file mã nguồn Mermaid:* [high_level_architecture.mmd](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/high_level_architecture.mmd)
...
![Kiến trúc Hệ thống Tổng quan](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/high_level_architecture.png)

---

## 2. Luồng Xác thực & Quay vòng Token (Auth & Token Rotation Flow)
🔗 *Xem file mã nguồn Mermaid:* [auth_token_rotation.mmd](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/auth_token_rotation.mmd)
...
![Luồng Xác thực & Quay vòng Token](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/auth_token_rotation.png)

---

## 3. Luồng Kết nối & Đăng ký WebSocket STOMP (WebSocket Connection & Subscription)
🔗 *Xem file mã nguồn Mermaid:* [websocket_stomp_flow.mmd](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/websocket_stomp_flow.mmd)
...
![Luồng Kết nối & Đăng ký WebSocket STOMP](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/websocket_stomp_flow.png)

---

## 4. Luồng gửi Tin nhắn thời gian thực (Real-time Messaging Pipeline)
🔗 *Xem file mã nguồn Mermaid:* [realtime_messaging_pipeline.mmd](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/realtime_messaging_pipeline.mmd)
...
![Luồng gửi Tin nhắn thời gian thực](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/realtime_messaging_pipeline.png)

---

## 5. Luồng Trạng thái Bạn bè (Friendship State Machine Flow)
🔗 *Xem file mã nguồn Mermaid:* [friendship_state_machine.mmd](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/friendship_state_machine.mmd)

Quản lý mối quan hệ giữa hai người dùng trong hệ thống với các ràng buộc về quyền riêng tư và khả năng chặn tin nhắn.

![Luồng Trạng thái Bạn bè](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/friendship_state_machine.png)

---

## 6. Sơ đồ Thực thể Cơ sở dữ liệu (Database Entity Relationship Diagram)
🔗 *Xem file mã nguồn Mermaid:* [database_erd.mmd](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/database_erd.mmd)
...
![Sơ đồ Thực thể Cơ sở dữ liệu](file:///C:/Users/quanc/Documents/Spring_Boot/Spring_chat/docs/diagrams/database_erd.png)
